function  [x,y,minX, minY, maxX, maxY,utmzone] = deg2utm(Lat,Lon)
% -------------------------------------------------------------------------
...
% Modified: Ioannis Mavromatis 2019
%-------------------------------------------------------------------------
...
[ minX, minY ] = findMin(x,y);
[ maxX, maxY ] = findMax(x,y);
end

function [ minX, minY ] = findMin(x,y)
minX = min(x);
minY = min(y);
end

function [ maxX, maxY ] = findMax(x,y)
maxX = max(x);
maxY = max(y);
end
