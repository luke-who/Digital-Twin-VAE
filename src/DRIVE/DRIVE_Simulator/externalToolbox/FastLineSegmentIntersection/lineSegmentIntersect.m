...
% INT_X = X1+X2_X1.*u_a; % Commented out for speeding the process
% INT_Y = Y1+Y2_Y1.*u_a; % Commented out for speeding the process
INT_B = (u_a >= 0) & (u_a <= 1) & (u_b >= 0) & (u_b <= 1);
% PAR_B = denominator == 0; % Commented out for speeding the process
% COINC_B = (numerator_a == 0 & numerator_b == 0 & PAR_B); % Commented out for speeding the process


% Arrange output.
out.intAdjacencyMatrix = INT_B;
% out.intMatrixX = INT_X .* INT_B; % Commented out for speeding the process
% out.intMatrixY = INT_Y .* INT_B; % Commented out for speeding the process
% out.intNormalizedDistance1To2 = u_a; % Commented out for speeding the process
% out.intNormalizedDistance2To1 = u_b; % Commented out for speeding the process
% out.parAdjacencyMatrix = PAR_B; % Commented out for speeding the process
% out.coincAdjacencyMatrix= COINC_B; % Commented out for speeding the process
